...
class AppearanceAnalyzer extends BaseGenderAnalyzer {
  ...
  /**
   * Analyze descriptions in proximity to character name
   * @param {string} name - Character name
   * @param {string} text - Text context
   * @param {Array} maleAppearance - Male appearance indicators
   * @param {Array} femaleAppearance - Female appearance indicators
   * @return {object} - Analysis results
   * @private
   */
  #analyzeProximityDescriptions(name, text, maleAppearance, femaleAppearance) {
    let maleScore = 0;
    let femaleScore = 0;
    let evidence = null;
