...
2. **Pull an AI Model**: Run `ollama pull qwen3.5:4b` (or another supported model)
...
- **Model Name**: Specify which Ollama model to use (default: qwen3.5:4b)
...
- **`qwen3.5:4b`** (default) — ~5 GB. Best all-around for dialogue enhancement.
